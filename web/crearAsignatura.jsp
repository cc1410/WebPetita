<%-- 
    ...
    Created on : 11-may-2018, 19:02:47
    Author     : Juan Elberto
--%>
    ...
    <body>
        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="col-md-2">
                    <a href="crearAsignatura.jsp"><button type="button" class="btn btn-crearAsignatura btn-lg btn3d"><span class="glyphicon glyphicon-ok"></span> Crear Asig.</button></a>
                </div>
            ...
            <div class="col-md-12">
                <form class="form-horizontal" method="POST" action="Registro">
                    <fieldset>
                        ...
                        <!-- Form Name -->
                        <legend>Crear una nuevo asignatura</legend>
